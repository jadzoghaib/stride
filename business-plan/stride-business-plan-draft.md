...
| **R10** | **Infrastructure costs exceed model** | 1 | 3 | **3** | Zero-egress architecture is a 9× saving already designed in. Infra is 3.1% of Y7 revenue |
...
- **Consistency:** an automated guard checks **282 prose claims across 14
