...
guard checks 274 prose claims across 14 documents** against the model and fails
the build if any figure drifts; a second guard evaluates all 2,500 workbook
