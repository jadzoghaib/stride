...
| Year 3 | A functioning two-sided market | 3,000 athletes, 230 paying sponsors, €0.53M net revenue |
...
relationships** and **a senior engineer**. Both are the first hires (§7.2), and
...
<!-- INCLUDE: 15-market-research.md shift=2 -->
...
pricing sets our unit economics (§6.10).
...
| Paying sponsors | 25 | 230 | 900 | 2,000 | 3,600 |
...
<!-- INCLUDE: 12-operations-plan.md shift=1 -->

# 6. Organization and human resources

<!-- INCLUDE: 13-organization-and-hr.md shift=1 -->
...
guard checks 263 prose claims across 14 documents** against the model and fails
the build if any figure drifts; a second guard evaluates all 2,010 workbook
...
## 7.5 Break-even and sensitivity
...
<!-- INCLUDE: 14-legal-and-growth.md shift=1 -->
